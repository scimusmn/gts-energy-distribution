...
const char str_1[] PROGMEM = "coal-1-switch";   // shift in board 1
const char str_2[] PROGMEM = "coal-2-switch";   // 2
const char str_3[] PROGMEM = "coal-3-switch";   // 3
const char str_4[] PROGMEM = "coal-4-switch";   // 4
const char str_5[] PROGMEM = "coal-1-jack";     // 5
const char str_6[] PROGMEM = "coal-2-jack";     // 6
const char str_7[] PROGMEM = "coal-3-jack";     // 5
const char str_8[] PROGMEM = "coal-4-jack";     // 6
const char str_9[] PROGMEM = "coal-5-jack";     // 7
const char str_10[] PROGMEM = "coal-6-jack";    // 8
const char str_11[] PROGMEM = "coal-5-switch";  // 11
const char str_12[] PROGMEM = "coal-6-switch";  // 12
const char str_13[] PROGMEM = "gas-1-jack";     // 13
const char str_14[] PROGMEM = "gas-2-jack";     // 14
const char str_15[] PROGMEM = "hydro-1-jack";   // 15
const char str_16[] PROGMEM = "hydro-2-jack";   // 16
const char str_17[] PROGMEM = "solar-1-jack";   // 17
const char str_18[] PROGMEM = "solar-2-jack";   // 18
const char str_19[] PROGMEM = "solar-3-jack";   // 19
const char str_20[] PROGMEM = "wind-1-jack";    // 20
const char str_21[] PROGMEM = "wind-2-jack";    // 21
const char str_22[] PROGMEM = "wind-3-jack";    // 22
const char str_23[] PROGMEM = "no-connection";  // 23
const char str_24[] PROGMEM = "no-connection";  // 24

// Table to refer to strings.
const char *const string_table[] PROGMEM = {
    str_17, str_18, str_19, str_20, str_21, str_22, str_23, str_24,
    str_9,  str_10, str_11, str_12, str_13, str_14, str_15, str_16,
    str_1,  str_2,  str_3,  str_4,  str_5,  str_6,  str_7,  str_8};
